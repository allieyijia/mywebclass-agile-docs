...
<!--- Effort estimate should be 3 hours max --->
...
Description: Design an upload form with a clear call-to-action and instructions on how to upload the website assignment. The form should be designed to accommodate the file formats and submission requirements that were determined during the research phase. Acceptance criteria include a clear and organized form design, with easy-to-follow instructions on how to upload the assignment. Dependencies include the research on file formats and submission requirements.
...
Description: Create a secure storage system to ensure that only the instructor can access the submitted assignments. The system should be designed to accommodate the file formats and submission requirements that were determined during the research phase. Acceptance criteria include a functional storage system that stores submitted assignments securely, and a notification system to inform the student when their assignment has been successfully uploaded and stored. Dependencies include the research on file formats and submission requirements, and the implementation of validation rules.
...
Description: Research the file formats and submission requirements for website assignments. This task includes identifying the accepted file formats for submissions, determining the maximum file size, and any other submission requirements. The acceptance criteria include creating a list of valid file formats, specifying the maximum file size, and documenting any other submission requirements.
...
Description: Test the upload functionality with different file formats to ensure that it works correctly and that the user is notified when their assignment has been successfully uploaded. This task includes testing the upload form with different file formats, checking that the correct files are uploaded and stored, and verifying that the student is notified when their assignment has been successfully uploaded. The acceptance criteria include verifying that the correct files are uploaded, ensuring that the student is notified when the upload is successful, and validating that the uploaded assignments are stored securely.
...
Notes: This task may depend on the completion of other tasks.
